package com.minatogithuborg.secrettestingtest1;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minatogithuborg.secrettestingtest1"})
@EnableCaching
...
public class SecretTestingTest1Application {

	public static void main(String[] args) {
		SpringApplication.run(SecretTestingTest1Application.class, args);
	}
